...
class _ClockLoaderState extends State<ClockLoader> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Clock Loader', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
      body: Center(
        child: Stack(
          children: [
